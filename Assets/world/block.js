...
const Blocks = Object.freeze({
    ...
    OakLeaves: new BlockType("leaves_oak", "Oak Leaves", .6),
    SpruceLog: new BlockType("log_spruce", "Spruce Log", 3),
    SpruceLeaves: new BlockType("leaves_spruce", "Spruce Leaves", .6),
    AcaciaLog: new BlockType("log_acacia", "Acacia Log", 3),
    AcaciaLeaves: new BlockType("leaves_spruce", "Acacia Leaves", .6),
    BirchLog: new BlockType("log_birch", "Birch Log", 3),
    BirchLeaves: new BlockType("leaves_oak", "Birch Leaves", .6)
});

class Block extends Square {
    constructor(blockType = Blocks.Air, wall = false) {
        super(new Transform(new Vector2(), new Vector2()), blockType == blockType.Air ? 0 : 1, blockType.sprite ? "blocks/" + blockType.sprite + ".png" : null, BLOCK_SIZE / 16, wall);
